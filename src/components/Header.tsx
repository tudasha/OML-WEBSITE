...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-hero-bg/95 backdrop-blur-md border-b border-white/10">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline text-sm text-white/70 font-medium">
              Oradea Music Lab
            </span>
          </Link>
      ...
      <div
        className={cn(
          "lg:hidden absolute top-full left-0 right-0 bg-hero-bg/98 backdrop-blur-md border-b border-white/10 transition-all duration-300",
